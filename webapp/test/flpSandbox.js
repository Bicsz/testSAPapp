		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Segezh Sign Files",
									"targetURL": "#segezhsignfiles-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"segezhsignfiles-display": {
								"semanticObject": "segezhsignfiles",
								"action": "display",
								"description": "A Fiori application for Segezh Sign Files",
								"title": "Segezh Sign Files",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=segezhsignfiles",
									"url": sap.ui.require.toUrl("segezhsignfiles")
								}
							}
						}
					}
